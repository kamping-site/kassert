...
#include <vector>
    ...
    /// @brief Default assertion level to `kassert::kassert::default` if not set explicitly.
...
#define KASSERT_ASSERTION_LEVEL_NORMAL 3

/// @brief Default assertion level. This level is used if no assertion level is specified.
constexpr int normal = KASSERT_ASSERTION_LEVEL_NORMAL;

/// @brief Assertions that perform lightweight communication.
#define KASSERT_ASSERTION_LEVEL_LIGHT_COMMUNICATION 4

/// @brief Assertions that perform lightweight communication.
constexpr int light_communication = KASSERT_ASSERTION_LEVEL_LIGHT_COMMUNICATION;

/// @brief Assertions that perform heavyweight communication.
#define KASSERT_ASSERTION_LEVEL_HEAVY_COMMUNICATION 5

/// @brief Assertions that perform heavyweight communication.
constexpr int heavy_communication = KASSERT_ASSERTION_LEVEL_HEAVY_COMMUNICATION;

/// @brief Assertion level for heavyweight assertions.
#define KASSERT_ASSERTION_LEVEL_HEAVY 6
